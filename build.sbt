...
libraryDependencies <<= scalaVersion { scala_version ⇒ Seq(
    ...
    "com.github.rhyskeepence" %% "clairvoyance-scalatest" % "1.0.82" % "test"
  ) ++ (
...
pomExtra :=
  <url>https://github.com/PILTT/silky-akka</url>
  <licenses>
    <license>
      <name>Apache 2</name>
  ...
  <scm>
    <url>git://github.com/PILTT/silky-akka.git</url>
    <connection>scm:git://github.com/PILTT/silky-akka.git</connection>
  </scm>
  <developers>
    <developer>
      <id>franckrasolo</id>
